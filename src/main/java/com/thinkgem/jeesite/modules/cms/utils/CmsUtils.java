...
public class CmsUtils {
	...
	private static CmsArticleDataGuideService articleDataGuideService = SpringContextHolder.getBean(CmsArticleDataGuideService.class);
	...
	/**
	 * 获取文章内容引导
	 * @param articleId 获取文章内容引导
	 * @return
	 */
	public static List<CmsArticleDataGuide> getArticleDataGuideList(String articleId){
		CmsArticleDataGuide articleDataGuide  =  new CmsArticleDataGuide();
		articleDataGuide.setArticleDataId(articleId);
		List<CmsArticleDataGuide> cmsArticleDataGuideList  = articleDataGuideService.findList(articleDataGuide);
		return cmsArticleDataGuideList ;
	}
